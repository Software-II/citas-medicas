...
SELECT A.IDMED, P.NOM, P.APEPAT, P.APEMAT, A.HORAINI, A.HORAFIN, A.CAPATEN FROM ATENCION A
...
ALTER TABLE CITAMEDICA
MODIFY COLUMN IDCITA int(10) auto_increment


SELECT * FROM PACIENTE;
UPDATE CITAMEDICA SET ESTADO=1 WHERE IDCITA=1;

SELECT C.IDCITA, C.IDSERV, S.NOMSERV, S.COSTO, C.IDMED, P.NOM, P.APEPAT, P.APEMAT, C.FECHA FROM CITAMEDICA C  INNER JOIN SERVICIO S ON C.IDSERV = S.IDSERV INNER JOIN PERSONA P ON C.IDMED = P.IDPER WHERE IDPAC=3 AND C.ESTADO=1;
